# Тестовое задание Backend/Django HardQode
...
2. В корневой директории создать и активировать виртуальное окружение:
...
3. Перейти в директорию **app_project** и выполнить миграции:
